...
<label for="filter_tahun" style="font-size: 0.875rem; font-weight: 600; color: var(--text-soft);">Tahun Perolehan:</label>
                <select name="tahun" id="filter_tahun" onchange="this.form.submit()" style="height: 36px; padding: 0 10px; border-radius: 6px;">
                    ...
                    <?php foreach ($results as $row): ?>
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                <a class="btn btn-sm btn-warning" href="add_edit.php?id=...">Edit</a>
